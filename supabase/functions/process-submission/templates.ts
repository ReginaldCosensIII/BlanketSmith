...
export function getEmailFooterHTML(): string {
  ...
  return `
    <table width="100%" cellpadding="0" cellspacing="0" class="email-footer" style="background: linear-gradient(to bottom, #1e293b, #0f172a); border-top: 1px solid #334155;">
      <tr>
        <td style="padding: 32px 20px 24px;">
            ...
            <tr>
              <td align="center">
                <table cellpadding="0" cellspacing="0">
                  <tr>
                    <td style="padding: 0 8px;"><a href="https://www.instagram.com/BlanketSmith_/" style="color: #a78bfa; font-size: 13px; font-family: Inter, system-ui, sans-serif; text-decoration: none;">Instagram</a></td>
                    <td style="padding: 0 8px;"><a href="https://www.x.com/BlanketSmith/" style="color: #a78bfa; font-size: 13px; font-family: Inter, system-ui, sans-serif; text-decoration: none;">X (Twitter)</a></td>
                    <td style="padding: 0 8px;"><a href="https://youtube.com/@blanketsmithdotcom" style="color: #a78bfa; font-size: 13px; font-family: Inter, system-ui, sans-serif; text-decoration: none;">YouTube</a></td>
                  </tr>
                  <tr><td height="8" style="font-size: 0; line-height: 0;">&nbsp;</td></tr>
                   <tr>
                    <td style="padding: 0 8px;"><a href="https://www.facebook.com/people/BlanketSmith/61585611386677/" style="color: #a78bfa; font-size: 13px; font-family: Inter, system-ui, sans-serif; text-decoration: none;">Facebook</a></td>
                    <td style="padding: 0 8px;"><a href="https://www.tiktok.com/@blanketsmith_" style="color: #a78bfa; font-size: 13px; font-family: Inter, system-ui, sans-serif; text-decoration: none;">TikTok</a></td>
                    <td style="padding: 0 8px;"><a href="https://discord.com/invite/cmsAYn7d" style="color: #a78bfa; font-size: 13px; font-family: Inter, system-ui, sans-serif; text-decoration: none;">Discord</a></td>
                  </tr>
                </table>
              </td>
            </tr>
          ...
          <table width="100%" cellpadding="0" cellspacing="0">
            <tr>
              <td align="center">
                <p style="color: #94a3b8; font-size: 12px; font-family: Inter, system-ui, sans-serif; margin: 0 0 16px;">
                  <a href="#" style="color: #94a3b8; text-decoration: underline;">Unsubscribe</a> · <a href="#" style="color: #94a3b8; text-decoration: underline;">Privacy Policy</a> · <a href="#" style="color: #94a3b8; text-decoration: underline;">Terms of Service</a>
                </p>
                <p style="color: #94a3b8; font-size: 12px; font-family: Inter, system-ui, sans-serif; margin: 0;">
                ...
                <p style="color: #94a3b8; font-size: 11px; font-family: Inter, system-ui, sans-serif; margin: 12px 0 0;">
    ...
    `${ASSET_BASE}icons/374FD9/community.png`
      ...
      <tr>
        <td>
          ${getEmailFeatureCardHTML(
    "Community First",
    "Join a growing community of passionate crafters where you can share patterns, get feedback, and find inspiration.",
