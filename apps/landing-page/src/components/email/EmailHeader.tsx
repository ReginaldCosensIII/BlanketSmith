...
const LIGHT_LOGO = "https://blanket-smith-landing-page.vercel.app/email-assets/PNG/light-version/Horizontal-Lockup-No-Slogan-PNG.png";
const DARK_LOGO = "https://blanket-smith-landing-page.vercel.app/email-assets/PNG/dark-version/Horizontal-Lockup-No-Slogan-PNG.png";
    ...
    <table width="100%" cellpadding="0" cellspacing="0" style="background-color: ${bgColor}; background-image: radial-gradient(ellipse 400px 300px at 0% 0%, ${orbColor1} 0%, transparent 70%), radial-gradient(ellipse 400px 300px at 100% 100%, ${orbColor2} 0%, transparent 70%), linear-gradient(to right, ${gridColor} 1px, transparent 1px), linear-gradient(to bottom, ${gridColor} 1px, transparent 1px); background-size: 100% 100%, 100% 100%, 24px 24px, 24px 24px;">
      <tr>
        <td align="center" style="padding: 40px 20px 40px;">
          ...
          <img src="${LIGHT_LOGO}" class="light-img" alt="BlanketSmith" width="180" style="display: block; max-width: 180px; height: auto;" />
          <img src="${DARK_LOGO}" class="dark-img" alt="BlanketSmith" width="180" style="display: none; max-width: 180px; height: auto; mso-hide: all;" />
        </td>
      </tr>
    </table>
  `;
